...
function createProducts(item){
        ...
        for (let i = 0; i < stars; i++){
            stringOfStars += `<img class="fullstar" src="img/star.png" alt=""></img>`
      ...
      <li class="galindo-regular">
        <ul><img class="listarrow" src="img/listarrow.png" alt="">${thing1}</ul>
        <ul><img class="listarrow" src="img/listarrow.png" alt="">${thing2}</ul>
        <ul><img class="listarrow" src="img/listarrow.png" alt="">${thing3}</ul>
      </li>
      <h2 class="galindo-regular">${price}.-</h2>
      <div class="addToCart" data-id="${id}">
        <img class="addcart" src="img/addcart.png" alt="">
